...
void GameItem::paint()
{
    ...
    QPointF mappedPoint;
    mappedPoint.setX(((pos.x-g_size.width()/2.0) * g_windowsize.width())/g_worldsize.width());
    mappedPoint.setY((1.0f - (pos.y+g_size.height()/2.0)/g_worldsize.height()) * g_windowsize.height());
